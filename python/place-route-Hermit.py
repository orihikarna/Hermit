...
def main():
    ...
    if board == BDL:
        ...
        kad.wire_mods( [
            ...
            # USB DP/DM
            ('U1', '21', 'R4', '2', w_mcu, (Dird, ([(2.6, 0)], -45), ([(0.5, -90), (0, 0)], 0), r_mcu)),
            ('U1', '22', 'R5', '2', w_mcu, (Dird, ([(3.0, 0)], -45), ([(0.5, +90), (0, 0)], 0), r_mcu)),
            # I2C
    ...
    if board == BDL:
        ...
        kad.wire_mods( [
            ...
            ('CL83', via_led_83, 'CL91', via_led_datLs['91'], w_dat,
                (Dird, ([(2, -90)], 70), ([(4, 90), (1.8, 60), (9, 90), (10, 180)], 90), r_dat), 'B.Cu'),
        ] )
