...
def main():
    ...
    for idx, key in enumerate( keys ):
        ...
        # Diode
        if idx > 0:
            pos = vec2.mult( mat2.rotate( -angle ), (-6.3, 0), sw_pos )
            kad.set_mod_pos_angle( 'D' + name, pos, -135 - angle )
    ...
    kad.move_mods( (0, 0), 0, [
        ...
        # ('C9', (-100, -125), 180),
        # USB DM/DP
        (None, (85, 45), 0, [ ('R4', (0, 0), 180), ('R5', (0, 2), 180) ] ),
        # I2C pull-up's
        (None, (35, 40), 0, [ ('R2', (0, 0), 90), ('R3', (2, 0), 90) ] ),
    ] )
