...
def main():
    ...
    if board == BZL:
        ...
        kad.wire_mods( [
            ...
            ('D13', '2', 'U1', '3', 0.45, (Dird, 0, ([(3.8, 180)], 90), -2.0)),
    ...
    if board == BZL:
        ...
        kad.wire_mods( [
            ...
            # dm/dp = I2C
            ('J1', via_splt_dmb, 'U1', '13', 0.45, (Dird, ([(4, 90)], 45), ([(3.6, 0), (19.4, 90), (1.2, 135)], 90), -1)),
            ('J1', via_splt_dpb, 'U1', '12', 0.45, (Dird, ([(3, 90)], 45), ([(2.8, 0), (18.4, 90), (1.2, 135)], 90), -1)),
        ] )
    if board == BZL:
        # mcu
