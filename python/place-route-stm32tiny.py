...
def main():
    ...
    kad.move_mods( (300, 350), 0, [
        ...
        ('C9', (-80, -152.5), 180),
        # USB DM/DP
        (None, (185, 115), 0, [ ('R6', (0, 0), 180), ('R7', (-20, 75), 180) ] ),
        # I2C pull-up's
    ...
    wire_mods( [
        ### mcu pass caps
        # mcu <--> Vcc x 2
        ('U1', '1', 'C3', '1', 20, (ZgZg, 90, 45)),# Vcc
        ('U1','32', 'C3', '2', 20, (ZgZg, 90, 45)),# Gnd
        ...
        # J1 left front
        ('U1','19', 'J1', '2', 20, (Dird, 0, ([(80, -45), (40, -90)], -45))),# PA9
        ('U1','20', 'J1', '3', 20, (Dird, 0, -45)),# PA10
        ('U1','23', 'J1', '4', 20, (Dird, 0, -45)),# PA13
        ('U1','24', 'J1', '5', 20, (Dird, 0, +45)),# PA14
        # J1 right
        ('U1','26', 'J1', '6', 20, (Dird, ([(40, 90), (14, 45)], 0), 45)),# PB3
        ('U1','27', 'J1', '7', 20, (Dird, ([(60, 90), (28, 45)], 0), 45)),# PB4
        ('U1','28', 'J1', '8', 20, (Dird, ([(80, 90), (42, 45)], 0), ([(80, 45), (56, 90)], 45))),# PB5
        ### regulator
        ...
        # DM/DP <--> R6, R7
        ('J4', 'A7', 'R6',  '1', 11.72, (Dird, ([(103, -90), (75, 0), (20, -90)], 0), ([(21, +90)], 0), 10)),# DM
        ('J4', 'B6', 'R7',  '1', 11.72, (Dird, ([( 81, -90), (75, 0), (20, -90)], 0), ([(21, -90)], 0), 10)),# DP
        # CC/BOOT0 Gnd
        ('R8', '2', 'R9', '2', 20, (Strt)),
        ('R8', '2', 'R3', '2', 20, (Strt)),
        ### BOOT0: mcu <--> R3
        ('U1', '31', 'R3', '1', 16, (Dird, ([(50, 90), (20, 0), (65, 90), (-50, 0), (80, 90), (20, 0)], 90), ([], 90), 30)),
        ### D3
        ('C5', '2', 'D3', '2', 16, (Dird, ([], 90), ([], 90), 5)),# Gnd
        ('D3', '4', 'J1', '1', 16, (Dird, ([], 90), ([], 45), 5)),# 5V
    ] )
    ...
    wire_mods_to_via( (68, 0), VIA_Size[1], [
        ('U1', '5', 20, (Dird, 90, 0)),
        ('C2', '1', 20, (Dird, 90, ([(48, +90)], 0), 25)),
        ('C6', '1', 20, (Dird, 90, ([(48, -90)], 0), 25)),
        ('C7', '1', 20, (Dird, 90, 90)),
    ] )
    # Gnd: C3
