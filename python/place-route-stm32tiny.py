...
def main():
    ...
    kad.move_mods( (300, 350), 0, [
        ...
        (None, (10, 0), 0, [
            ('U1', (0, 0), angle_mcu),
            # pass caps
            (None, ( 255, -160),   0, [ ('C3', (0, 0), -90), ('C4', (0, 0), -90) ] ),
            (None, (-255,  160), 180, [ ('C5', (0, 0), -90), ('C6', (0, 0), -90) ] ),
            # Vdda pass caps
            (None, ( 105, -160),   0, [ ('C7', (0, 0), -90), ('C8', (75, 0), -90) ] ),
        ] ),
        # NRST
        ('C9', (-80, -175), 180),
        # D2
        (None, (-250, 15), 0, [ ('D2', (0, 0), 90), ('R2', (0, 0), -90) ] ),
        # USB DM/DP
        (None, ( 152.5, 120), 0, [ ('R7', (0, 0), 180), ('R8', (0, 75), 180) ] ),
        # I2C pull-up's
        (None, (-115, 160), 0, [ ('R5', (0, 0), 90), ('R6', (75, 0), 90) ] ),
        # regulators
        (None, (0, 0), 0, [
            ('U2', (   0, 6), 90),
            ('C1', ( 115, 0), 90),
        ...
        ('SW1', (525, -270), -90),
        # D1 (power)
        (None, (575, 285), 0, [ ('D1', (0, 0), 0), ('R1', (0, 0), 0)  ] ),
    ] )
    ...
    kad.wire_mods( [
        ...
        ### pin headers
        # J3
        ('U1', '9', 'J3', '2', 20, (Dird, ([], 90), ([], +45), 5)),# PA3
        ('U1', '8', 'J3', '1', 20, (Dird, ([], 90), ([], -45), 5)),# PA2
        # J2 front
        ('U1', '7', 'J2', '1', 20, (Dird, ([], 0), ([], +45), 5)),# PA1
        ('U1', '6', 'J2', '2', 20, (Dird, ([], 0), ([], +45), 5)),# PA0
        ('U1', '4', 'J2', '3', 20, (Dird, ([], 0), ([], +45), 5)),# NRST
        ('U1', '3', 'J2', '4', 20, (Dird, ([], 0), ([], +45), 5)),# PF1
        ('U1', '2', 'J2', '5', 20, (Dird, ([], 0), ([], -45), 5)),# PF0
        ('C3', '1', 'J2', '6', 24, (Dird, ([], 0), ([], +45), 5)),# Vcc
        # J2 back
        ('C9', '1', 'J2', '3', 20, (Dird, ([], 90), ([], 45), 5)),# NRST
        ('C4', '1', 'J2', '6', 24, (Dird, ([], 0), ([], +45), 5)),# Vcc
        ...
        ### USB
        # DM/DP
        ('J4', 'A6', 'J4', 'B6', 11.72, (Strt2, [(40, +90)], [(40, +90)], 9)),# DP
        ('J4', 'A7', 'J4', 'B7', 11.72, (Strt2, [(40, -90)], [(40, -90)], 9)),# DM
        ('J4', 'B6', 'R8',  '1', 11.72, (Strt2, [(56, -90)], [(20, -90), (40, 180)], 5)),# DP
        ('J4', 'A7', 'R7',  '1', 11.72, (Strt2, [(70, -90)], [(20, +90), (40, 180)], 5)),# DM
    ] )
